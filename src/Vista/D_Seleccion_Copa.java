 ...
 * @author jromero
 */
public final class D_Seleccion_Copa extends javax.swing.JDialog {
String columna,texto;
     ...
     * @param modal
     */
    public D_Seleccion_Copa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        actualizartabla();
    ...
    private void initComponents() {
        ...
        setTitle("SELECCION DE COPA A ENLAZAR");
        setModal(true);
        ...
        jLabel21.setText("FILTRAR COPAS POR:");
        ...
        jTextField17.setText("Escriba aqui para filtrar una copa.!");
        ...
        jLabel1.setText("                ¡SELECCIONE LA COPA QUE DESEA ENLAZAR CON EL ARBOL.!");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (jTextField1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this,"DEBE SELECCIONAR UNA COPA PARA PODER ENLAZARLA A UN ARBOL.!");
    ...
    private void jTextField17KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField17KeyReleased
        ...
        jTable1.setModel(gc.FILTRO(columna, texto));
...
jTextField17.setText("");
        jTextField17.setForeground(Color.black);        // TODO add your handling code here:
 ...
 jTextField17.setForeground(Color.gray);
        jTextField17.setText("Escriba aqui para filtrar una copa.!");        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_Seleccion_Copa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_Seleccion_Copa dialog = new D_Seleccion_Copa(new javax.swing.JFrame(), true);
...
if(!(jTextField1.getText().isEmpty())){
 ...
 String cod_copa=(jTextField1.getText()); 
 ResultSet rs;
 Connection con = new Conexion().getCon();
 
    try {
        rs= con.createStatement().executeQuery("select  COPAS.cod_copa,colectores.nombre,DONANTE_COPAS.NOMBRE from COPAS INNER JOIN DONANTE_COPAS ON COPAS.COD_DONANTE=DONANTE_COPAS.COD_DONANTE INNER JOIN COLECTORES ON COPAS.IDENTIFICACION_COLECTOR=COLECTORES.IDENTIFICACION_COLECTOR where cod_copa= "+jTextField1.getText()+";");
        if (rs.next()) {
         
         
         Accesador.arbol_T_colector_copa.setText(rs.getString(2));
         Accesador.arbol_T_donante_copa.setText(rs.getString(3));
         Accesador.arbol_T_cod_copa.setText(jTextField1.getText());
         if (!(Accesador.arbol_T_cod_copa.getText().isEmpty())&&!(Accesador.arbol_T_cod_patron.getText().isEmpty())) {
           ...
           //Accesador.ARBOL_CONTROL="C"+Accesador.arbol_T_cod_copa.getText()+" - "+"P"+Accesador.arbol_T_cod_patron.getText();
        }
...
public  void actualizartabla(){
    Gestion_Copa gc = new Gestion_Copa();
    jTable1.setModel(gc.LISTARTABLA());
}
