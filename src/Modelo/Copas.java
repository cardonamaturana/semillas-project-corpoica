...
public class Copas {
    ...
    public String toString() {
        return "Copas{" + "Identificacion_colector=" + Identificacion_colector + ", Estado_Enlazado=" + Estado_Enlazado + ", Cod_Copa=" + Cod_Copa + ", Nombre_C_Cultivo=" + Nombre_C_Cultivo + ", Nombre_Comun_Accesion=" + Nombre_Comun_Accesion + ", Estado_Accesion=" + Estado_Accesion + ", Fuente_Coleccion=" + Fuente_Coleccion + ", Latitud=" + Latitud + ", Longitud=" + Longitud + ", Altitud=" + Altitud + ", Genero=" + Genero + ", Especie=" + Especie + ", D_A_P=" + D_A_P + ", Altura=" + Altura + ", Observaciones=" + Observaciones + ", cod_Donante=" + cod_Donante + ", Fecha_Colecta=" + Fecha_Colecta + '}';
    }
    ...
    public Copas(long Identificacion_colector, int Estado_Enlazado, int Cod_Copa, String Nombre_C_Cultivo, String Nombre_Comun_Accesion, String Estado_Accesion, String Fuente_Coleccion, String Latitud, String Longitud, String Altitud, String Genero, String Especie, String D_A_P, String Altura, String Observaciones, String cod_Donante, Object Fecha_Colecta) {
        this.Identificacion_colector = Identificacion_colector;
        this.Estado_Enlazado = Estado_Enlazado;
        this.Cod_Copa = Cod_Copa;
        this.Nombre_C_Cultivo = Nombre_C_Cultivo;
